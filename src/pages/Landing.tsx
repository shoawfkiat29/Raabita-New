        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          >
            ...
            <span className="text-3xl md:text-4xl font-display font-bold tracking-tight text-white flex items-center gap-3">
              Raabita <span className="text-[28px] leading-[37px] font-['Courier_New'] font-bold opacity-60">رابطہ</span>
            </span>
          </motion.div>
          <motion.nav
            initial={{ opacity: 0, x: 20 }}
      ...
      <main>
        ...
        <section ref={targetRef} className="relative min-h-screen flex items-center pt-20 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-6 w-full z-10">
            ...
            >
              <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-[17px] font-medium text-indigo-300 mb-8 backdrop-blur-sm">
